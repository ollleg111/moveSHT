...
public class PeymentMethodFragment extends BaseFragment {
    ...
    public static PeymentMethodFragment newInstance() {
        PeymentMethodFragment fragment = new PeymentMethodFragment();
